<section id="tabla_preguntas" class="tab-content closed">
    <section class="accesos-directos w-full">
        <header class="pt-8 flex justify-center items-center">
            ...
            <h2 class="text-center text-3xl inline">Listado de Preguntas frecuentes</h2>
        ...
        <section class="actions flex justify-center py-8">
            <a href="/panel/pregunta/crear" class="btn-rounded btn btn-uno-transparent font-bold py-2 px-4 flex justify-center items-center"><span class="fas fa-plus text-3xl"></span></a>
        </section>
