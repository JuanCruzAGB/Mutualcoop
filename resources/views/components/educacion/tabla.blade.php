<section id="tabla_educaciones" class="tab-content closed">
    <section class="accesos-directos w-full">
        ...
        <section class="actions flex justify-center py-4">
            <a href="/panel/educacion/crear" class="btn-rounded btn btn-uno-transparent font-bold py-2 px-4 flex justify-center items-center"><span class="fas fa-plus text-3xl"></span></a>
        </section>
