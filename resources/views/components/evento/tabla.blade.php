<section id="tabla_eventos" class="tab-content closed">
    <section class="accesos-directos w-full">
        <header class="pt-8 flex justify-center items-center">
            ...
            <h2 class="text-center text-3xl inline">Listado de Eventos</h2>
        ...
        <div class="buscador-box w-full py-4 flex justify-center items-center pt-4 mb-4">
            <div class="buscador">
                ...
                <input id="lupa-input" data-name="evento-search" class="filter filter-search buscador-input outline-none" type="search" placeholder="Buscar">
            </div>
        </div>
    </section>
