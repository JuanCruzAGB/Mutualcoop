            ...
            <tr>
                <td style="background-color: #ecf0f1">
                    <div style="color: #34495e; margin: 4% 10% 2%; text-align: justify;font-family: sans-serif">
                        ...
                        <p style="margin: 2px;padding-top: 2rem;text-align: center;font-family: sans-serif;font-size: 17px;min-height: 70px;background-color: #f8f8f8;padding: 1rem 1rem;margin-bottom: 2.5rem;">¡Muchas gracias por haberse registrado a <a style="font-family: sans-serif;text-decoration:none;color: #0F1626;" target="_blank" href="https://mutualcoop.org.ar">Mutualcoop</a>!<br />Por favor confirme su correo electrónico.<br /><br />Cualquier duda o consulta puede escribirnos a <b>info@mutualcoop.org.ar</b><br /><br />De no haber sido usted por favor ignore este correo.<br />¡Muchas Gracias!</p>
                        <div style="width: 100%; text-align: center">
                            <a style="font-family: sans-serif;text-decoration:none;border-radius:5px;padding:11px 23px;color:white;background-color: #0F1626;"target="_blank" href="https://mutualcoop.org.ar/email/{{$data->token}}/confirm">Confirmar correo</a>
                        </div>
