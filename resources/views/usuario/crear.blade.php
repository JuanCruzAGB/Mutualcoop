...
@section('css')
    ...
    <link href={{ asset('css/usuario/crear.css') }} rel="stylesheet">
@endsection
...
@section('main')
    <header class="md:flex md:justify-center background background-dos w-full">
        <section class="form-container mx-auto w-10/12 md:w-6/12 lg:w-5/12 background background-dos px-6">
            <form id="usuario-crear" class="px-4 my-12 rounded-lg lg:px-4 rounded w-full bg-white none" action="/usuario/crear"    
                method="post"
                data-rules="{{json_encode($validation->rules)}}"
                data-messages="{{json_encode($validation->messages)}}">
                <header>
                    <h2 class="text-2xl text-center py-8">Crear Usuarios</h2>
                </header>
                @csrf
                <div class="input-group mb-4 lg:flex lg:justify-center lg:flex-wrap">
                    <input name="id_suscriptor"
                        ...
                        type="number" placeholder="Número de Suscriptor" value="{{old('id_suscriptor', $id_suscriptor)}}">
                ...
                <div class="input-group mb-4 lg:flex lg:justify-center lg:flex-wrap">
                    <input name="correo"
                        class="form-input w-full appearance-none border-none p-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        type="email" placeholder="Email *" title="Campo obligatorio" value="{{old('correo')}}">
                ...
                <div class="input-group mb-4 lg:flex lg:justify-center lg:flex-wrap">
                    ...
                    <input id="clave_confirmation" name="clave_confirmation" placeholder="Repite tu contraseña *" title="Campo obligatorio"
                        class="form-input w-full appearance-none border-none p-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        type="password">
                ...
                <div class="mb-4 flex justify-center flex-wrap mb-8 outline-none">
                    <select class="form-input p-3 outline-none bg-white" name="id_nivel" title="Campo obligatorio">
                        <option {{ !old("id_nivel") ? 'selected' : '' }} disabled>Nivel de Usuario</option>
                            <option {{ old('id_nivel') == 1 ? 'selected' : '' }} value="1">Suscriptor</option>
                            <option {{ old('id_nivel') == 2 ? 'selected' : '' }} value="2">Administrador</option>
                    </select>
                ...
                <div class="suscriptor hidden">
                    <div class="input-group mb-4 lg:flex lg:justify-center lg:flex-wrap">
                        <input name="entidad"
                            class="form-input w-full appearance-none border-none p-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                            type="text" placeholder="Entidad *" title="Campo obligatorio" value="{{old('entidad')}}">
                    ...
                    <div class="input-group mb-4 lg:flex lg:justify-center lg:flex-wrap">
                        <input name="direccion"
                            class="form-input w-full appearance-none border-none p-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                            type="text" placeholder="Dirección" value="{{old('direccion')}}">
                    ...
                    <div class="input-group mb-4 lg:flex lg:justify-center lg:flex-wrap">
                        <input name="telefono"
                            class="form-input w-full appearance-none border-none p-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                            type="text" placeholder="Teléfono *" title="Campo obligatorio" value="{{old('telefono')}}">
                    ...
                    <div class="input-group mb-4 lg:flex lg:justify-center lg:flex-wrap">
                        <input name="cbu"
                            class="form-input w-full appearance-none border-none p-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                            type="number" placeholder="CBU" value="{{old('cbu')}}">
                    @if($errors->has('cbu'))
                    ...
                    <div class="input-group mb-4 lg:flex lg:justify-center lg:flex-wrap">
                        <input name="cuit_cuil"
                            class="form-input w-full appearance-none border-none p-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                            type="number" placeholder="CUIT / CUIL" value="{{old('cuit_cuil')}}">
                    ...
                    <div class="mb-4 flex justify-center flex-wrap mb-8 outline-none">
                        <select class="form-input p-3 outline-none bg-white" title="Campo obligatorio" name="id_tipo_suscripcion">
                            <option {{ !old("id_tipo_suscripcion") ? 'selected' : '' }} disabled>Tipo de Suscripción</option>
                                <option {{ old('id_tipo_suscripcion') == 1 ? 'selected' : '' }} value="1">Debito</option>
                                <option {{ old('id_tipo_suscripcion') == 2 ? 'selected' : '' }} value="2">Semestral</option>
                    ...
                    <div class="avanzado hidden">
                        <div class="input-group mb-4 lg:flex lg:justify-center lg:flex-wrap">
                            <input name="correo_facturacion"
                                class="form-input w-full appearance-none border-none p-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                type="email" placeholder="Correo de facturación" value="{{old('correo_facturacion')}}">
                    ...
                    @endif
                        ...
                        <div class="input-group mb-4 lg:flex lg:justify-center lg:flex-wrap">
                            <input name="correo_informacion"
                                class="form-input w-full appearance-none border-none p-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                type="email" placeholder="Correo de información" value="{{old('correo_informacion')}}">
                    ...
                    @endif
                        ...
                        <div class="input-group mb-4 lg:flex lg:justify-center lg:flex-wrap">
                            <input name="whatsapp"
                                class="form-input w-full appearance-none border-none p-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                type="text" placeholder="WhatsApp" value="{{old('whatsapp')}}">
                    ...
                    @endif
                        ...
                        <div class="input-group mb-4 lg:flex lg:justify-center lg:flex-wrap">
                            <input id="alta" type='text' name="alta" class='form-input datepicker-here w-full appearance-none border-none p-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline' 
                                data-language='es' data-position="bottom center" placeholder="Fecha alta" value="{{old('alta')}}"/>
                    ...
                    @endif
                        ...
                        <div class="input-group mb-4 lg:flex lg:justify-center lg:flex-wrap">
                            <input id="baja" type='text' name="baja" class='form-input datepicker-here w-full appearance-none border-none p-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline' 
                                data-language='es' data-position="bottom center" placeholder="Fecha baja" value="{{old('baja')}}"/>
                    ...
                    @endif
                        ...
                        <div class="mb-4 flex justify-center flex-wrap mb-8 outline-none">
                            <select class="form-input p-3 outline-none bg-white" name="estado">
                                <option {{ !old("estado") ? 'selected' : '' }} disabled>Estado</option>
                                    <option {{ old('estado') === 0 ? 'selected' : '' }} value="0">Dado de baja</option>
                                    <option {{ old('estado') == 1 ? 'selected' : '' }} value="1">Pendiente de Confirmación</option>
                                    <option {{ old('estado') == 2 ? 'selected' : '' }} value="2">Pendiente de Aprobación</option>
                                    <option {{ old('estado') == 3 ? 'selected' : '' }} value="3">Activo</option>
                            </select>
                    ...
                    @endif
                        ...
                        <div class="mb-4 flex justify-center flex-wrap my-8 outline-none">
                            <textarea class="form-input ckeditor descripcion resize-none" id="detalles" name="detalles" placeholder="Detalles"
                                cols="100" rows="10">{!!old('detalles')!!}</textarea>
                ...
                <div class="flex items-center justify-center lg:justify-center py-4">
                    <input class="form-submit usuario-crear btn btn-dos p-2 px-8 my-4" type="submit" value="Crear Usuario">
                </div>
            </form>
        </section>
    </header>
...
@section('js')
    <script>
        const suscriptions = [];
        const oldNivel = @json(old('id_nivel'));
        let oldAvanzado = false;
        let oldProvincia = @json(old('provincia'));
        if(@json(old('correo_facturacion')) || @json(old('correo_informacion'))|| @json(old('whatsapp')) || @json(old('baja')) || @json(old('alta')) || @json(old('estado')) || @json(old('detalles'))){
            oldAvanzado = true;
        }
        @if(old('alta'))
        const alta = @json(old('alta'));
        @else
        const alta = '';
        @endif
        @if(old('baja'))
        const baja = @json(old('baja'));
        @else
        const baja = '';
        @endif
    ...
    <script type="module" src={{ asset('js/usuario/crear.js') }}></script>
@endsection
